...
We looked at the variables and it looked like we have a numerical variables which is the numerical variable that is going to be how much vitamin C (this is a numerical variable) is containted between the two cultivation methods.Those cultivation methods are called c39 and c52 methods and those are the categorial variables.
...
I reject the jull hypothesis because the chances are an extremely small number and that chance is 0.00000003405, in conclusion is that c39 and c52 are significantly different, you get more using the mothod of cultivation from c52.
